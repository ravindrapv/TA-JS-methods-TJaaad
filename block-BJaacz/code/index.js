...
*/
function isAdult(personDetailes) {
  return personDetailes.age >18;
}
/*
...
*/
function isMale(personDetailes) {
  return personDetailes.sex === "M";
}
/*
...
*/
function isFemale(personDetailes) {
  return personDetailes.sex === "F";
}
/*
...
*/
function isGradeA(personDetailes){
  return personDetailes.grade >12;
}
/*
...
*/
function isGradeB(personDetailes) {
  return personDetailes.grade >8 && personDetailes.grade <= 12
};
/*
...
*/
function isGradeC(personDetailes){
  return personDetailes <= 8;
}
